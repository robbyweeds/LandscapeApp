...
b1 = Button(root, text='Add Plants', command=wF.open_plant_window(e3_var.get(), e2_var.get(),e1_var.get() )).grid(row=3, column=0, padx=padding_x, pady=padding_y)
